...
Superseded by [Dap Library](pedal-library.md), which is the only planned Gallery/Library feature spec for future visual Library behavior. This file is retained only as historical context and must not be used as implementation authority.
