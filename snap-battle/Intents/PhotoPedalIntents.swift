...
struct CreatePedalIntent: AppIntent {
    ...
    static let description = IntentDescription("Abre a câmera para criar um novo Photo Pedal.")
...
struct PlayLastPedalIntent: AppIntent {
    ...
    static let description = IntentDescription("Toca o último Photo Pedal criado.")
    static let openAppWhenRun = true
...
struct PhotoPedalShortcuts: AppShortcutsProvider {
