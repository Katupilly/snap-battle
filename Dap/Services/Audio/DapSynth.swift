...
enum DapSynthStopReason: Equatable, Sendable {
    case requested
    case interruption
    case engineFailure
}
...
protocol PedalPlaying: AnyObject {
    ...
    var stopHandler: ((DapSynthStopReason) -> Void)? { get set }
...
@MainActor
final class DapSynth: NSObject, PedalPlaying {
    ...
    private func stop(reason: DapSynthStopReason) {
