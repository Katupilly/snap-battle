        ...
        ScrollView {
            VStack(spacing: 20) {
                Image(uiImage: item.cover)
                    ...
                    .accessibilityLabel("Capa 2-bit de \(item.pedal.name), nota predominante \(item.pedal.dominantPitchClass.accessibilityName)")
                ...
                Text("Nota predominante: \(item.pedal.dominantPitchClass.symbol)")
                    .font(.subheadline.weight(.semibold))
                    .accessibilityLabel("Nota predominante: \(item.pedal.dominantPitchClass.accessibilityName)")
