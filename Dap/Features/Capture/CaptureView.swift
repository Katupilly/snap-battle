...
private struct CaptureGradientBackground: View {
    var body: some View {
        ZStack {
            ...
            LinearGradient(
                colors: [.clear, .white.opacity(0.7), .cyan.opacity(0.3), .clear],
            ...
            RadialGradient(
                colors: [.white.opacity(0.85), .cyan.opacity(0.32), .clear],
                center: .center,
                startRadius: 2,
                endRadius: 46
            )
...
struct CameraScreen: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                HStack {
                    VStack(alignment: .leading) { Text("Dap").font(.headline.bold()); Text("Enquadre uma textura ou cena").font(.subheadline) }.foregroundStyle(.white)
                    Spacer()
