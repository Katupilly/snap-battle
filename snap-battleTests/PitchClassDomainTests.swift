...
struct PitchClassDomainTests {
    ...
    @Test func musicDomainFilesDoNotImportSwiftUIOrUIColor() throws {
        let repository = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
        let files = [
            repository.appendingPathComponent("snap-battle/Domain/Music/PitchClass.swift"),
            repository.appendingPathComponent("snap-battle/Domain/Music/DominantPitchClassResolver.swift"),
            repository.appendingPathComponent("snap-battle/Domain/Music/PitchColorIdentity.swift"),
        ]
        for file in files {
